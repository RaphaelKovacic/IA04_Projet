...
/**
 * <b>SondageAgent est la classe représentant l'agent sondage dans notre SMA Parlement.</b>
 * <p>
 ...
 * Les comportements de l'agent Sondage sont spécifiés dans les quatre classes suivantes
 * </p>
 * 
 * 
...
public class SondageAgent extends Agent{
     ...
     * <p>
     * Lors du lancement de notre plateforme JADE, l'agent Sondage est créé grâce à cette méthode setup()
     * </p>
     */
	 ...
	 * <p>Il est de type Cyclic. Notre agent Sondage est en constante attente d'une requête PROPOSE de l'agent Médiateur qui lui demande les valeurs actuelles des variables d'environnement
	 * </p>
	 * <p>
	 * Il implémente le comportement suivant :
	 * Récupèrer le message demandant les valeurs des variables d'environnement actuelles.
	 * <p>
	 * 
	 * Cette action faite suite à une demande de sondage de la part de l'utilisateur.
	 * 
	 ...
	 * <p>Il est de type OneShot. Notre agent Sondage ne fait ce comportement qu'une seule fois. Lorsque le médiateur lui a déjà demandé de lui fournir les variables d'nevironnement du pays.
	 * </p>
	 * <p>
	 * Il implémente le comportement suivant :
	 * Envoyer un message à l'agent environnement pour connaitre l'état de ses variables
	 * <p>
	 * 
	 * Cette action faite suite à une demande des valeurs des variables par l'agent médiateur à notre agent Sondage. Voir Behaviour ci-dessus.
	 * 
	 * @author Benoit
	 * @version 1.1
	 */
	...
	/**
	 * <b>ReponseOfEnvironnement est le troisième Behaviour de l'agent Sondage</b>
	 * <p>Il est de type Cyclic. Notre agent Sondage est en constante attente d'une requête INFORM de l'agent Environnement qui répond au message envoyé par notre agent Sondage lui demandant les valeurs de ses variables d'environnements.
	 * </p>
	 * <p>
	 * Il implémente le comportement suivant :
	 * RRecupérer le message de l'agent environnement avec les valeurs de
	 * <p>
	 * 
	 * Cette action faite suite à une demande de sondage de la part de l'utilisateur.
	 * 
	...
	/**
	 * <b>GiveVarToMediat est le quatirème et dernier Behaviour de l'agent Sondage</b>
	 * <p>Il est de type OneShot. Notre agent Sondage va afficher les variables d'environnements envoyées par l'agent environnement seulement lorsqu'il a reçu ces mêmes variables.
	 * </p>
	 * <p>
	 * Il implémente le comportement suivant :
	 ...
	 * <p>
	 * 
	 * Cette action faite suite et finie l'action de demande de sondage de la part de l'utilisateur.
	 * 
	 * </p>
	 * 
	 * @author Benoit
