...
/**
 * <b>SimulationAgent est la classe représentant l'agent simulation dans notre SMA Parlement.</b>
 * <p>
 ...
 * Les comportements de l'agent simulation sont spécifiés dans les quatre classes suivantes
 * </p>
 * 
 * 
 * @author Benoit 
...
public class SimulationAgent extends Agent{
     ...
     * <p>
     * Lors du lancement de notre plateforme JADE, l'agent Simulation est créé grâce à cette méthode setup()
     * </p>
     */
	 ...
	 * <p>Il est de type OneShot. Notre agent Simulation va utiliser ce Behaviour pour créer un nouveau tour. Il est instancier lorsque l'agent simulation reçoit un message de fin de tour par l'agent mediateur ou une requete du joueur.
	 * </p>
	 * <p>
	 * Il implémente le comportement suivant :
	 * Crée un nouveau tour de jeu.
	 * <p>
	 * 
	 ...
	 * <p>Il est de type Cyclic. Notre agent Simulation est constamment dans l'attente de recevoir un message de la part du médiateur. Il va ensuite instancier le behaviour correspondant si un nouveau tour doit être crée.
	 * </p>
	 * <p>
	 * Il implémente le comportement suivant :
	 * Réceptionne une communication par message de la part du médiateur.
	 * <p>
	 * 
	 * 
	 ...
	 * <p>Il est de type Cyclic. Notre agent Simulation est constamment dans l'attente de recevoir un message INFORM de la part de l'environnement. Lors de la réception de ce message c'est que la parti est terminée.
	 * </p>
	 * <p>
	 * Il implémente le comportement suivant :
	 * Réceptionne un message de fin de la partie de la part de l'environnement.
	 * <p>
	 * 
	...
	/**
	 * <b>WaitMessMediateur est le quatirème et dernier Behaviour de l'agent Simulation</b>
	 * <p>Il est de type Cyclic. Notre agent Simulation est constamment dans l'attente de recevoir un message de type REQUEST de la part du joueur. Il va ensuite instancier le behaviour correspondant si un nouveau tour doit être crée.
	 * </p>
	 * <p>
	 * Il implémente le comportement suivant :
	 * Réceptionne une communication par message de la part du joueur.
	 * <p>
	 * 
	 * 
	 * @see SimulationAgent#NouvTourMediateur
