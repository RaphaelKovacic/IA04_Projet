 ...
 * </p>
 * 
 * <p> Loi est une classe servant notamment à serializer en JSON une loi.
 * Elle est utilisée dans l'échange de messages entre agents.
 * </p>
 * <p> La classe Loi implémente l'interface Comparable pour permettre la comparaison automatiquede lois grâce à la methode sort()
 * </p>
...
public class Loi implements Comparable<Loi> {
	...
	/**
     * La valeur l'influence sur le paramètre qualité de vie qui décrit le bien être de la population du pays. Cette valeur n'est pas modifiable.
	...
	/**
     * La valeur l'influence sur le paramètre santé économique qui décrit la santé économique du pays. Cette valeur n'est pas modifiable.
	...
	/**
     * La liste des partis politiques susceptibles de proposer cette loi. Cette liste n'est pas modifiable.
	...
	/**
     * Le nom du député proposant la loi. Cette chaune de caractère n'est pas modifiable.
	...
	/**
     * La valeur du paramètre "influence" du proposant de la loi. Cette valeur n'est pas modifiable.
	...
	/**
     * La valeur du paramètre "charisme" du proposant de la loi. Cette valeur n'est pas modifiable.
     * @see Loi#getCharisme()
	...
	/**
     * La valeur du paramètre "popularité" du proposant de la loi. Cette valeur n'est pas modifiable.
     * Cette valeur correspond à la côté de popularité dont bénéficie le député vis à vis du peuple.
	...
	/**
     * La valeur du paramètre "notoriété" du proposant de la loi. Cette valeur n'est pas modifiable.
     * Cette valeur correspond à la côté de popularité dont bénéficie le député vis à vis des entreprises.
     ...
     * <p>
     * Affiche seulement ce que l'utilisateur doit voir de la loi (éviter la triche).
     * </p>
     *
     */
     ...
     * 
     * @return La liste de chaines de caractères correspondant aux partis politiques susceptibles de proposer la loi.
     */
     ...
     * 
     * @param _l_PartiPolitique
     *            La nouvelle liste des partis politiques pouvant proposer la loi.
     * 
     */
	@JsonSetter
	...
	/**
     * Retourne une booléen issu de la comparaison entre deux lois.
     * Méthode obligatoire pour implémenter complétement l'interface Comparable.
